...
export const gemstones = [
    {
        ...
        priceUSD: 28500,
        description: "An exceptional 3.2-carat unheated Ceylon Blue Sapphire exhibiting the coveted 'Royal Blue' color. LGL certified with outstanding clarity and brilliance.",
    ...
    },
    {
        ...
        certificate: "LGL",
        shape: "Cushion",
        dimensions: { length: 7.8, width: 6.5, height: 4.2 },
        priceUSD: 45000,
        description: "The rarest of all sapphires - a natural Padparadscha displaying the perfect lotus flower color. LGL certified, unheated, and exceptionally rare.",
    ...
    },
    {
        ...
        certificate: "LGL",
        shape: "Oval",
        dimensions: { length: 7.5, width: 5.8, height: 4.1 },
        priceUSD: 35000,
        description: "A stunning Burmese Ruby exhibiting the highly prized 'Pigeon Blood' color. Certified by LGL laboratory with exceptional saturation.",
    ...
    },
    {
        ...
        certificate: "LGL",
        shape: "Emerald Cut",
        dimensions: { length: 10.5, width: 8.2, height: 6.3 },
        priceUSD: 52000,
    ...
    },
    {
        ...
        certificate: "LGL",
        shape: "Cushion",
        dimensions: { length: 11.2, width: 9.1, height: 6.8 },
        priceUSD: 18500,
    ...
    },
    {
        ...
        certificate: "LGL",
        shape: "Heart",
        dimensions: { length: 8.5, width: 8.2, height: 5.1 },
        priceUSD: 22000,
