    ...
    return (
        <div className="min-h-screen bg-[#fafaf9] pt-32 pb-20">
            <div className="premium-container">
                ...
                >
                    <Sparkles className="w-12 h-12 text-[#0d9488] mx-auto mb-6" />
                    <h1 className="text-5xl font-heading mb-4">Fine Jewelry</h1>
                    <p className="text-[#44403c] max-w-2xl mx-auto">
                        Handcrafted masterpieces featuring Ceylon's finest gemstones,
                        set in precious metals by our master artisans.
                    </p>
                </motion.div>
                ...
                <div className="flex gap-12">
                    ...
                    <div className="flex-1">
                        <p className="text-sm text-[#44403c] mb-6">{filteredJewelry.length} pieces</p>

                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                            {filteredJewelry.map((product, index) => (
                                <motion.div
                                    key={product.id}
                                ...
                                >
                                    <Link to={`/product/${product.slug}`}>
                                        <div className="relative overflow-hidden h-[350px] mb-4 bg-white shadow-lg">
                                            <img
